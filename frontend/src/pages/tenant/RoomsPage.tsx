...
const useRoomsPageState = () => {
  ...
  return { deleteActions, handleToggleForm, isWholeUnit, navigate, state };
};
...
const RoomsPageLayout: FC<RoomsPageLayoutProps> = ({ deleteActions, handleToggleForm, isWholeUnit, navigate, state }) => (
