...
export const buildDashboardStatItems = (stats: DashboardStats | null) => [
  ...
  { icon: TrendingUp, label: "Pendapatan Bulan Ini", value: formatCurrency(stats?.monthlyRevenue || 0), color: "text-green-600 bg-green-50 dark:bg-green-900/20" },
];
