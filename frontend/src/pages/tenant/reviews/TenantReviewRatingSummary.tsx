...
import { useReviewSummaryPage, type ReviewSummaryPage } from "@/hooks/tenant/reviews/useReviewSummaryPage";
...
const SummaryPanel: FC<SummaryPanelProps> = ({ icon, items, title }) => {
  const page = useReviewSummaryPage(items);
  return (
...
const SummaryPagination: FC<{ page: ReviewSummaryPage; totalItems: number }> = ({ page, totalItems }) => (
