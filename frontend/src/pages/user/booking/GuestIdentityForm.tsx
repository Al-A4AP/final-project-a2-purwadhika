...
type FieldKey = "domicileAddress" | "email" | "ktpAddress" | "legalName" | "name" | "phone";
...
const fields: { key: FieldKey; label: string; placeholder: string; required?: boolean }[] = [
  ...
  { key: "ktpAddress", label: "Alamat sesuai KTP", placeholder: "Alamat pada KTP", required: true },
  { key: "domicileAddress", label: "Alamat Domisili", placeholder: "Alamat tinggal saat ini" },
];
