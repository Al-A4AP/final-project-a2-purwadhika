...
export const DashboardUpcomingStay: FC<DashboardUpcomingStayProps> = ({
      ...
      <div className="mb-8">
        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-8 dark:border-slate-800 dark:bg-slate-900">
          <EmptyState
            ...
            description="Anda tidak memiliki reservasi mendatang. Temukan tempat menginap impian Anda sekarang."
          />
  ...
  return (
    <div className="mb-8">
      <h2 className="mb-4 text-xl font-bold text-slate-900 dark:text-white">
        Reservasi Terkonfirmasi Terbaru
      </h2>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="h-48 md:w-1/3 md:h-auto overflow-hidden bg-slate-200 dark:bg-slate-800">
            {order.property?.featured_image_url ? (
              <img
                src={order.property.featured_image_url}
          ...
          <div className="flex flex-1 flex-col justify-between p-6 md:p-8">
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
              ...
              <Link
                to={`/orders/${order.id}`}
                className="flex items-center text-sm font-bold text-red-600 transition hover:text-red-700 dark:text-red-500 dark:hover:text-red-400"
              >
