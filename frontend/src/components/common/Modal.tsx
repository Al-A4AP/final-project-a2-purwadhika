...
export const Modal: FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-9999 animate-fade-in">
      <div 
        className={`bg-white dark:bg-slate-800 rounded-2xl w-full ${maxWidthClasses[maxWidth]} shadow-2xl border border-gray-100 dark:border-slate-700 flex flex-col max-h-[90vh]`}
      >
