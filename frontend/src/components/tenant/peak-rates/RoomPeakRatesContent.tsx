  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 overflow-y-auto">
      <div className="bg-white dark:bg-slate-800 rounded-xl max-w-lg w-full p-6 space-y-6 shadow-xl border dark:border-slate-700">
        ...
        <PeakRatesListSection peakRates={props.peakRates} onDeleteRate={props.onDeleteRate} />
        <PeakRateForm peakForm={props.peakForm} onFormChange={props.onFormChange} onAddRate={props.onAddRate} />
