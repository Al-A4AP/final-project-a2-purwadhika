  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
    <div className="w-full max-w-md space-y-4 rounded-xl bg-white p-6 shadow-xl dark:bg-slate-800">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-500">Pilih rentang tanggal, pilih aksi, lalu konfirmasi. Tanggal customer tidak bisa diubah dari modal ini.</p>
      </div>
      <AvailabilityActionToggle isAvailable={props.isAvailable} onChange={props.onAvailableChange} />
      <AvailabilityCalendar tenantBlockedDays={props.tenantBlockedDays} customerBookedDays={props.customerBookedDays} range={props.range} onRangeChange={props.onRangeChange} />
      <AvailabilityLegend />
