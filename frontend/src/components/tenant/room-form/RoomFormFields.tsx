...
export const RoomFormFields: FC<RoomFormFieldsProps> = ({ form, isEditing, isWholeUnit, editingRoom, onChange, fetchRooms, setEditingRoom }) => (
  <div className="grid grid-cols-2 gap-3">
    ...
    <RoomTextField form={form} onChange={onChange} inputClass={roomInputClass} name="base_price" label="Harga Dewasa/malam (Rp)" type="number" min="0" step="10000" isPrice placeholder="500000" required />
