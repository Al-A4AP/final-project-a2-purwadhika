...
import { MAX_DAILY_PRICE } from "@/constants/validation";
...
export const RoomChildPriceField: FC<{ form: RoomFormInput; inputClass: string; onChange: (form: RoomFormInput) => void }> = (props) => (
  <div>
    <RoomTextField {...props} name="child_price" label="Harga Anak-anak/malam (Rp)" type="number"
      min="1" max={String(MAX_DAILY_PRICE)} step="10000" isPrice placeholder="Kosongkan jika = dewasa" />
