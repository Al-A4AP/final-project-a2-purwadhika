...
export const OccupancyHeader: FC<{ canGoPrev?: boolean; month: number; onNext: () => void; onPrev: () => void; year: number }> = (props) => (
  <div className="flex w-full items-center justify-between gap-4 sm:w-auto sm:justify-start">
    <MonthNavButton direction="prev" disabled={!props.canGoPrev} onClick={props.onPrev} />
